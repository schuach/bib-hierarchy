...
* Alternativen
  Es gibt eine (vermutlich deutlich professionellere) Implementierung dieser Funktionalität von [[https:https://github.com/gabriele-h][gabriele-h]] von der Universitätsbibliothek Wien, die auch aktiv gepflegt wird:

  [[https:https://github.com/gabriele-h/bib-hierarchy]]


  Für Endbenutzer:
  [[https:https://bibdata.univie.ac.at/bib-hierarchy/]]
